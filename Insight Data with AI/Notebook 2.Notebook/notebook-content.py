...
df = spark.read.table("AzureDatabricks.sales_silver")
...
DeltaTable.createIfNotExists(spark) \
    .tableName("AzureDatabricks.dimdate_gold") \
...
DeltaTable.createIfNotExists(spark) \
    .tableName("AzureDatabricks.dimcustomer_gold") \
...
dfdimCustomer_temp = spark.read.table("AzureDatabricks.dimCustomer_gold")
...
DeltaTable.createIfNotExists(spark) \
    .tableName("AzureDatabricks.dimproduct_gold") \
...
DeltaTable.createIfNotExists(spark) \
    .tableName("AzureDatabricks.factsales_gold") \
    .addColumn("CustomerID", LongType()) \
    .addColumn("ItemID", LongType()) \
    .addColumn("OrderDate", DateType()) \
...
spark.sql(f"""
    CREATE TABLE IF NOT EXISTS AzureDatabricks.sales_silver
    USING DELTA
...
dfdimCustomer_temp = spark.read.table("AzureDatabricks.dimCustomer_gold")
dfdimProduct_temp = spark.read.table("AzureDatabricks.dimProduct_gold")
